...
echo "Ora per utilizzare il bot telegram devi ottenere un token, segui le indicazioni che trovi qui: https://core.telegram.org/bots."
echo "Quando hai il token, inseriscilo nel file /home/pi/mytokens.py"
